...
object InitialDataSource {
    ...
    fun getCharacters(): List<Characters> {
        return listOf(
            ...
            Characters(23, "手", "shǒu", "hand", "我的手很小。", "Wǒ de shǒu hěn xiǎo.", "My hands are small.", "null", 2, 2),
            Characters(24, "腳", "jiǎo", "foot", "我的腳很痛。", "Wǒ de jiǎo hěn tòng.", "My feet hurt.", "null", 2, 7),
            Characters(25, "頭", "tóu", "head", "我的頭很大。", "Wǒ de tóu hěn dà.", "My head is big.", "null", 2, 11),
            Characters(26, "眼", "yǎn", "eye", "我的眼睛是藍色的。", "Wǒ de yǎnjīng shì lán sè de.", "My eyes are blue.", "null", 2, 5),
            Characters(27, "耳", "ěr", "ear", "我的耳朵很大。", "Wǒ de ěrduo hěn dà.", "My ears are big.", "null", 2, 6),
            Characters(28, "口", "kǒu", "mouth", "我的口很渴。", "Wǒ de kǒu hěn kě.", "My mouth is thirsty.", "null", 2, 0),
            Characters(29, "鼻", "bí", "nose", "我的鼻子很小。", "Wǒ de bízi hěn xiǎo.", "My nose is small.", "null", 2, 14),
            Characters(30, "心", "xīn", "heart", "我的心很累。", "Wǒ de xīn hěn lèi.", "My heart is tired.", "null", 2, 1),
            Characters(31, "面", "miàn", "face", "你的面很漂亮。", "Nǐ de miàn hěn piàoliang.", "Your face is beautiful.", "null", 2, 10),
            Characters(32, "身", "shēn", "body", "我的身體很健康。", "Wǒ de shēntǐ hěn jiànkāng.", "My body is healthy.", "null", 2, 9),
            Characters(33, "血", "xuè", "blood", "我的血型是O型。", "Wǒ de xuèxíng shì O xíng.", "My blood type is O.", "null", 2, 8),
            Characters(34, "牙", "yá", "tooth", "我的牙很白。", "Wǒ de yá hěn bái.", "My teeth are white.", "null", 2, 3),
            Characters(35, "皮", "pí", "skin", "我的皮膚很白。", "Wǒ de pífū hěn bái.", "My skin is white.", "null", 2, 4),
            Characters(36, "髮", "fà", "hair", "我的頭髮很長。", "Wǒ de tóufa hěn cháng.", "My hair is long.", "null", 2, 13),
            Characters(37, "骨", "gǔ", "bone", "我的骨頭很硬。", "Wǒ de gǔtou hěn yìng.", "My bones are hard.", "null", 2, 12),
